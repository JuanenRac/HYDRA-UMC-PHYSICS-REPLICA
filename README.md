...
Pure software simulation engine, no own hardware design - so this project
carries no `hardware/`, `firmware/` or `os/` folders (see the folder-pruning
rule in `SONNET/5.PLAN_EJECUCION_32_PROYECTOS_NUEVOS.txt`).
